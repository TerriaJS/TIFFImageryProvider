...
## [2.10.5-terria.1.1]() (2024-06-25)

### TerriaJS specific modifications

* Move canvas initialisation out of global scope

## [2.10.5-terria.1](https://github.com/TerriaJS/TIFFImageryProvider/tree/c50f0afaef14500a8b71401d83e83cf53790d174/packages/TIFFImageryProvider) (2024-06-24)

### TerriaJS specific modifications

- Update imports to be from `terriajs-cesium` instead of cesium
- Update readme and give credit to Upstream
- Change build target
- Translate comments and add TerriaJS specific comments
